...
exports.DEVICE_PROFILES = void 0;
exports.selectRandomDevice = selectRandomDevice;
exports.selectDeviceByManufacturer = selectDeviceByManufacturer;
...
function selectRandomDevice() {
    ...
    const byPopularity = {
        very_high: exports.DEVICE_PROFILES.filter(d => d.popularity === 'very_high'),
        high: exports.DEVICE_PROFILES.filter(d => d.popularity === 'high'),
        medium: exports.DEVICE_PROFILES.filter(d => d.popularity === 'medium'),
        low: exports.DEVICE_PROFILES.filter(d => d.popularity === 'low')
    };
    ...
    return exports.DEVICE_PROFILES[Math.floor(Math.random() * exports.DEVICE_PROFILES.length)];
}
/**
 * Seleciona dispositivo de uma marca específica
 */
function selectDeviceByManufacturer(manufacturer) {
    const filtered = exports.DEVICE_PROFILES.filter(d => d.manufacturer.toLowerCase() === manufacturer.toLowerCase());
...
function getDeviceStats() {
    const stats = {
        total: exports.DEVICE_PROFILES.length,
        byManufacturer: {},
        byPopularity: {},
        byAndroidVersion: {}
    };
    for (const device of exports.DEVICE_PROFILES) {
        // Por fabricante
...
exports.default = exports.DEVICE_PROFILES;
